...
export interface ApiMetaDataMetaData extends Struct.CollectionTypeSchema {
  collectionName: 'portfolio_meta_data';
  info: {
    displayName: 'Meta Data';
    pluralName: 'portfolio-meta-data';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    metaDescription: Schema.Attribute.RichText & Schema.Attribute.Required;
    metakeywords: Schema.Attribute.Component<'seo.seo', true>;
    metatitle: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Yash Patel | Portfolio'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMyServicesMyServices extends Struct.CollectionTypeSchema {
  collectionName: 'portfoliomy_services';
  info: {
    displayName: 'My Services';
    pluralName: 'portfoliomy-services';
    singularName: 'my-services';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    features: Schema.Attribute.Component<'sub-feature.my-services', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::my-services.my-services'
    > &
      Schema.Attribute.Private;
...
export interface ApiProjectsProjects extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    category: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Web App'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.RichText & Schema.Attribute.Required;
    hasLiveLink: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    techtools: Schema.Attribute.Component<'projects.techstack', true>;
